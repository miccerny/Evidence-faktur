                ...
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="mb-3">
                        <InputField
                            ...
                            value={person.name}
                            customValidationMessage="Prosím vyplňte jméno!"
                            handleChange={(e) => {
                    ...
                    <div className="mb-3">
                        <InputField
                            ...
                            customValidationMessage="Prosím zadejte IČO"
                    ...
                    <InputField
                        ...
                        customValidationMessage="Prosím zadejte DIČ"
                    ...
                    <InputField
                        ...
                        customValidationMessage="Prosím zadejte číslo účtu"
                    ...
                    <InputField
                        ...
                        customValidationMessage="Prosím zadejte kod banky"
                    ...
                    <InputField
                        ...
                        label="IBAN"
                        prompt="Zadejte IBAN"
                        customValidationMessage="Prosím zadejte IBAN"
                        value={person.iban}
                        handleChange={(e) => {
                    ...
                    <InputField
                        ...
                        customValidationMessage="Prosím zadejte telefon"
                    ...
                    <InputField
                        ...
                        label="Mail"
                        prompt="Zadejte mail"
                        customValidationMessage="Prosím zadejte email"
                        value={person.mail}
                        handleChange={(e) => {
                    ...
                    <InputField
                        ...
                        customValidationMessage="Prosím zadejte ulici"
                        value={person.street}
                        handleChange={(e) => {
                    ...
                    <InputField
                        ...
                        label="PSČ"
                        prompt="Zadejte PSČ"
                        customValidationMessage="Prosím zadejte PSČ"
                        value={person.zip}
                        handleChange={(e) => {
                    ...
                    <InputField
                        ...
                        customValidationMessage="Prosím zadejte město"
                        value={person.city}
                        handleChange={(e) => {
